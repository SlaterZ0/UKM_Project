...
<head>
  ...
  <title>TC Empire Ordering System : Orders Details</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['PRODUCTS_ID']; ?>"><?php echo $productrow['PRODUCTS_NAME']; ?></option>
          <?php
          }
          $conn = null;
          ?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <tr>
        ...
        <td><?php echo $detailrow['Quantity']; ?></td>
        <td>
