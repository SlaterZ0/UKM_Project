...
<head>
  ...
  <title>TC Empire Ordering System : Staffs</title>
  <!-- Bootstrap -->
        ...
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          ...
          <form action="staffs.php" method="post" class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input name="sid" type="text" class="form-control" id="staffid" placeholder="Staff ID" value="<?php if (isset($_GET['edit'])) echo $editrow['Staff_ID']; ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label for="staffname" class="col-sm-3 control-label">Name</label>
              <div class="col-sm-9">
                <input name="name" type="text" class="form-control" id="staffname" placeholder="Name" value="<?php if (isset($_GET['edit'])) echo $editrow['Staff_Name']; ?>" required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input name="password" type="password" class="form-control" id="password" placeholder="Password" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_pass']; ?>" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input name="repassword" type="password" class="form-control" id="repassword" placeholder="Retype Password" value="<?php if (isset($_GET['edit'])) echo $editrow['fld_pass']; ?>" required>
              </div>
            </div>
      ...
      <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <table class="table table-striped table-bordered">
          ...
          try {
            ...
            $stmt = $conn->prepare("select * from tbl_staffs_a187103 LIMIT $start_from, $per_page");
            $stmt->execute();
          ...
          ?>
            <tr>
              ...
              <?php if ($pos === 'Admin') { ?>
                <td><?php echo $readrow['fld_pass']; ?></td>
              <?php } ?>
              <?php if ($pos === "Admin") { ?>
                <td>
